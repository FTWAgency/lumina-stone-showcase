        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-muted rounded-xl flex items-center justify-center hover:bg-primary/20 transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors duration-300">Care Instructions</a></li>
              <li><a href="#" className="hover:text-primary transition-colors duration-300">Sample Library</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 font-sans text-muted-foreground">
              ...
              <li><a href="#" className="hover:text-primary transition-colors duration-300">Press & Media</a></li>
              <li><a href="/dealer/login" className="hover:text-primary transition-colors duration-300">Dealer Login</a></li>
            </ul>
          </div>
        </div>
