...
const dealers = [
  {
    id: 1,
    name: "Piedrafina Surfaces",
    address: "3940 Garner Rd",
    city: "Riverside",
    state: "CA",
    zip: "92501",
    tagline: "Southern California's Premier Surface Destination",
    distance: 0,
    lat: 33.9533,
    lng: -117.3962,
  },
  {
    id: 2,
    name: "Formation Stone Surfaces",
    address: "74824 42nd Ave",
    city: "Palm Desert",
    state: "CA",
    zip: "92260",
    tagline: "Serving the Coachella Valley",
    distance: 0,
    lat: 33.7222,
    lng: -116.3745,
  },
